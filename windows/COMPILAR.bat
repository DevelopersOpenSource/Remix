...
"%GPP%" -std=gnu++20 -O2 -w -municode -mwindows -static -s -B"%BDIR%" -I"%COMUM%" -I. main.cpp audio_backend.o app_res.o -o "%EXEOUT%" -lgdiplus -lshell32 -lcomdlg32 -lole32 -luuid -lwinmm -lwinhttp -lws2_32 -liphlpapi -ldwmapi -lcrypt32
if errorlevel 1 goto :falhou
